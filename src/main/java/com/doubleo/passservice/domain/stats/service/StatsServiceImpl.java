...
public class StatsServiceImpl implements StatsService {
    ...
    @Override
    public List<DailyStatInfoResponse> getDailyPeriodStatList() {
        ...
        return entryStatsDailyRepository
                .findDailyEnteredSumByDate(tenantId, today, startDate)
                .stream()
                .map(row -> DailyStatInfoResponse.of((LocalDate) row[0], (Long) row[1]))
                .toList();
    }
}
